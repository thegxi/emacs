...
(setq-default tab-width 2)           ; Tab 宽度设置为 2
(setq-default standard-indent 2)     ; 标准缩进设置为 2
(setq-default c-basic-offset 2)      ; C 语言系列缩进为 2
...
(setq-default fill-column 80)        ; 默认每行 80 字符换行
...
;; 设置 Maple Mono Font，字号 13 (130 = 13pt)
